  ...
  -webkit-filter: blur(8px);*/
    ...
    <body>
        <div class="bg">
            ...
            <header class="header-basic">
                   ...
                   <nav>
                       ...
                       <a href="adlogin.html" style="color: red;"">Login</a>
                       <a href="clregister.html" style="color: red;"">Sign Up</a>
        ...
        <div class="header">
         ...
         <form method="POST" enctype="multipart/form-data" action="apartreg.php" id="form">
                 ...
                 <div class="input-group">
                   ...
                   <input type="text" name="location" placeholder="Location" maxlength="6" required>
                 </div>
                 <div class="input-group">
                   <!--<label>Description:</label>-->
                   <input type="text" name="desc"placeholder=" Brief Description" maxlength="300"required>
                   </div>
                 <div class="input-group">
                   <!--<label>Price:</label>-->
