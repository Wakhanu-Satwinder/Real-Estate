...
<html>
  ...
  -webkit-filter: blur(8px);*/
    ...
    <body>
        <div class="bg">
            ...
            <header class="header-basic">
                   ...
                   <nav>
                       ...
                       <a href="inter.html" style="color: red;"">Login</a>
        ...
        <form  method="POST" enctype="application/x-www-form-urlencoded" action="clregister.php" class="form-horizontal" style="width:275px">
           ...
           <div class="input-group">
		   <button type="submit" class="btn" name="reg_client">Register</button>
		   </div>
		 <p>
  		   Already a member? <a href="cllogin.html">Sign in</a>
  	     </p>
	   </form>
